...
const requiredSourceText = {
  ...
  'app/(tabs)/index.tsx': ['Estimated current level', 'Shot day is', 'How are you feeling?', 'First weight logged.'],
  'app/log-shot/index.tsx': ['recommendNextSite', 'suggestedId=', 'detailsOpen', "'Log shot'", 'height * 0.46'],
